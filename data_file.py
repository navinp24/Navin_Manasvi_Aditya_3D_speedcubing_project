...
def rubiks_cube_solver_color(scr,solution):
    # Cubelet positions
    ...
    for move in sol:
        ...
        if rotating[idx]:
            ...
            rotating[idx] = False
            # print(notation, end=" ", flush=True)
        time.sleep(0.3)  # small delay to avoid flicker or accidental double-press
